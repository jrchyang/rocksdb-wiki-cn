...
- 详情：[[How-to-Backup-RocksDB]]

## Base Level 

- 中文：基础级别
- 释义：第一个被排序的层级，所以通常是 Level 1，但当启用 [`level_compaction_dynamic_level_bytes`](https://github.com/facebook/rocksdb/blob/b52620ab0ea049cb0e6c17b09779065337662e01/include/rocksdb/advanced_options.h#L644) 时，可能就不是这样了。只要在第 0 层和基础层（[[Leveled-Compaction|详情]]）之间没有数据，它可以是任何更低的层
